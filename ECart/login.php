    ...
    <div class="login-page">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <form id="loginform" action="" method="post">
		  ...
		  <li><?php
                 if(isset($_GET['id'])){
                 echo "<font color='#f9172d' size='2'>Please Login to continue..</font>";
                   }?></li>
            ...
            <li><span>Password</span>
              <input name="password" type="password" placeholder="Enter Password" class="input-text" />
            </li>
			<li><?php
                 if(isset($loginerror)){
                 echo "<font color='#f9172d' size='2'>Wrong Credentials. Please sign in again.</font>";
                   }?></li>	
            <li>
              <input type="submit" class="btn btn-success submit" name="login" value="Submit" />
            </li>
                      </ul>
          <span class="pull-left new_cust"> <a href="forgotpassword.php">Forgot Password</a> </span> <span class="pull-right new_cust"> New customer? <a href="signup.php">signup</a></span>
        </form>
      </div>
